...
class Order extends Model
{
    ...
    protected $fillable = ['user_id', 'tracking_no', 'customer_name', 'customer_email', 'customer_address', 'customer_mobile_no', 'city_id', 'shipping_method_id', 'grand_total', 'device_id', 'customer_details'];
